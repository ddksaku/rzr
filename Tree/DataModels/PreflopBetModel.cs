...
{
    [Editor(typeof(PreflopRangeEditor))]
    public class PreflopBetModel : BetTreeNodeDataModel
    {
        #region property declarations

        public HandRangeModel Range { get; private set; }
        ...
        public PreflopBetModel(PlayerModel player, HoldemHandRound round, BetTypeModel betType) : base(betType)
        {
            Player = player;
            Round = round;
        ...
        {
            PreflopBetModel model = sender as PreflopBetModel;
        ...
        {
            PreflopEvaluator ret = new PreflopEvaluator(this.Player.Index, this.Range.Range);
            return ret;
        }
        ...
        public override BetTreeNodeMetaXml SaveToXml()
        {
            ...
            ret.Name = BetTreeNodeService.PREFLOP_NODE_META;
            return ret;
        }
    }
}
